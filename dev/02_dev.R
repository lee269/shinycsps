...
## 2.1 Add modules
## 
golem::add_module( name = "question_select" ) # Name of the module
golem::add_module( name = "core_question_select" ) # Name of the module
...
golem::add_module( name = "engagement_facet_chart")
...
## 3.1 Vignette
usethis::use_vignette("shinycsps")
